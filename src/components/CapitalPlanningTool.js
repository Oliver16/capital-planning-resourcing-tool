...
import ProjectEffortTemplatesPanel from "./tabs/ProjectEffortTemplatesPanel";
        ...
        <div className="space-y-6">
          ...
          {activeTab === "templates" && (
            <ProjectEffortTemplatesPanel
              ...
              projectTypes={projectTypes}
              staffCategories={staffCategories}
              onSaveTemplate={upsertProjectEffortTemplate}
              onDeleteTemplate={removeProjectEffortTemplate}
              onApplyTemplate={applyProjectEffortTemplate}
              isReadOnly={isReadOnly}
            />
          )}
